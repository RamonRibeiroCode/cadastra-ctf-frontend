interface DateLightProps {
  width: number;
  height: number;
}

export default function DateLight({ width, height }: DateLightProps) {
  return (
    <svg
      width={width}
      height={height}
